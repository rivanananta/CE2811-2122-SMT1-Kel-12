...
String wifiSSID = "MRAS";
String wifiPassword = "12345678q";
...
TBMessage tMessage;
String token = "5695197577:AAH902rdwm9Ebs5U8V7vO-BxrfxIAg3qiD4";
CTBot myBot;
...
void loop()
{
    ...
    if (myBot.getNewMessage(tMessage))
    {
        ...
        if (tMessage.messageType == CTBotMessageText)
        {
            ...
            {
                String reply = "";
                reply += "Hi, Selamat Datang "+ tMessage.sender.firstName + " dibot Kelompok 12\n";
